...
exports.BlueAgentImmunizer = void 0;
class BlueAgentImmunizer {
    synthesizePatch(report, sourceContent) {
    ...
    generateUnifiedDiff(filePath, original, modified) {
...
exports.BlueAgentImmunizer = BlueAgentImmunizer;
