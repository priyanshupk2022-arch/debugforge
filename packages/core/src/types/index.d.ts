import { z } from 'zod';
export type VulnerabilityCategory = 'COMMAND_INJECTION' | 'PROTOTYPE_POLLUTION' | 'BROKEN_AUTH_IDOR';
export declare const VulnerabilityCategorySchema: z.ZodEnum<["COMMAND_INJECTION", "PROTOTYPE_POLLUTION", "BROKEN_AUTH_IDOR"]>;
